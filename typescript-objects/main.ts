// In main.ts, define an interface named StudentProps with the following properties:
interface StudentProps {
  firstName: string;
  lastName: string;
  age: number;

  livesInIrvine?: boolean; // Optional property
...
// Define a Pet interface below the Vehicle interface:
// Optional Properties:
// name: a string
// kind: a string
interface Pet {
